...
export interface TransferResult { copied:number; skipped:number; failed:number; deleted:number; bytes:number; scanned:number; dryRun:boolean; items:Array<{path:string;action:string}>; }
